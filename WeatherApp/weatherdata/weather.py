...
def GetWeatherData(long_lat):
    url = "https://api.open-meteo.com/v1/forecast?latitude=" + \
        ...
        str(long_lat[0]) + \
        "&hourly=temperature_2m,relativehumidity_2m,dewpoint_2m,precipitation_probability,precipitation,cloudcover,visibility,evapotranspiration&daily=weathercode,temperature_2m_max,temperature_2m_min,apparent_temperature_max,apparent_temperature_min,sunrise,sunset,uv_index_max,rain_sum,precipitation_hours,windspeed_10m_max,windgusts_10m_max&current_weather=true&forecast_days=1&timezone=Australia%2FSydney"
